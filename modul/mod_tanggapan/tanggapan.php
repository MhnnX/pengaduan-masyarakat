  ...
  switch (isset($_GET['act']) ? $_GET['act'] : '') {
    ...
    default:
      echo "<h2>Tanggapan</h2>
          <table>
          <tr><th>no</th><th>petugas</th><th>tgl pengaduan</th><th>tgl tanggapan</th><th>Judul</th><th>status</th><th>aksi</th></tr>";
      ...
      while ($r = mysqli_fetch_array($tampil)) {
        ...
        <td><a href=?module=tmasyarakat&act=detail&id=$r[Id_Tanggapan]>Detail</a> | 
        <a href=$aksi?module=tmasyarakat&act=hapus&id=$r[Id_Tanggapan] onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">Hapus</a>
        </td></tr>";
        $no++;
      }
      echo "</table>";
